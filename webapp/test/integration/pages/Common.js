sap.ui.define([
	...
	return Opa5.extend("kite.worklist.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["mycompany/myapp/worklist/localService/mockserver"], function (mockserver) {
